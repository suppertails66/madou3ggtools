#ifndef LASTBIBLELINEWRAPPER_H
#define LASTBIBLELINEWRAPPER_H
...
class LastBibleLineWrapper : public BlackT::TLineWrapper {
public:
  typedef std::map<int, int> CharSizeTable;

  LastBibleLineWrapper(BlackT::TStream& src__,
