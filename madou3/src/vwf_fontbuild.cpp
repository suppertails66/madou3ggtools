...
const static int numChars = 0xE0;
const static int charsPerRow = 16;
const static int slotNum = 2;
...
//      pattern.setData(i, j, orig.data(7, 0));
      pattern.setData(i, j, backgroundColor);
    }
  }
}
...
int main(int argc, char* argv[]) {
  if (argc < 4) {
    cout << "Sega Master System/Game Gear VWF font builder" << endl;
  ...
  backgroundColor = TStringConversion::stringToInt(string(argv[3]));
